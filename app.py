...
# 💡 核心優化：利用數學公式動態調整 K 棒實體寬度(k_width) 與引線粗細(line_width)
# 當天數為 5 時，寬度約為 6.8；當天數為 200 時，寬度會平滑縮小到 1.5，保證絕不相撞重疊！
...
# 繪製 K 棒實體（加入 edgecolors='black' 與 linewidth=0.2 增加細節分明感）
